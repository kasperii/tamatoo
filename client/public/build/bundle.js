...
var app = (function () {
    ...
    // (776:16) {#each collist as col}
    function create_each_block(ctx) {
    	let button;
    	let t_value = /*col*/ ctx[49].name + "";
    	let t;
    	let mounted;
    	let dispose;

    	function click_handler() {
    		return /*click_handler*/ ctx[16](/*col*/ ctx[49]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			add_location(button, file, 776, 20, 19157);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(776:16) {#each collist as col}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	function controller_movement_binding(value) {
    		/*controller_movement_binding*/ ctx[17](value);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div8, file, 850, 8, 21021);
    			attr_dev(img, "class", "overlay svelte-1rwmkqc");
    			add_location(img, file, 851, 8, 21178);
    			attr_dev(div9, "class", "blur-container svelte-1rwmkqc");
    			add_location(div9, file, 847, 4, 20799);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
