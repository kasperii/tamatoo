...
var app = (function () {
    ...
    // (789:16) {#each collist as col}
    function create_each_block(ctx) {
    	let button;
    	let t_value = /*col*/ ctx[50].name + "";
    	let t;
    	let mounted;
    	let dispose;

    	function click_handler() {
    		return /*click_handler*/ ctx[16](/*col*/ ctx[50]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			add_location(button, file, 789, 20, 19621);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(789:16) {#each collist as col}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	function controller_movement_binding(value) {
    		/*controller_movement_binding*/ ctx[18](value);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 787, 12, 19523);
    			attr_dev(input0, "name", "s");
    			attr_dev(input0, "placeholder", "speed");
    			add_location(input0, file, 793, 13, 19797);
    			attr_dev(input1, "name", "d");
    			attr_dev(input1, "placeholder", "direction");
    			add_location(input1, file, 794, 16, 19852);
    			attr_dev(input2, "name", "r");
    			attr_dev(input2, "placeholder", "rotation");
    			add_location(input2, file, 795, 16, 19911);
    			attr_dev(input3, "type", "submit");
    			input3.value = "create";
    			add_location(input3, file, 796, 13, 19966);
    			attr_dev(form, "class", "svelte-1rwmkqc");
    			add_location(form, file, 792, 12, 19737);
    			attr_dev(input4, "type", "text");
    			attr_dev(input4, "id", "speech-text");
    			attr_dev(input4, "placeholder", "Enter text to speak");
    			add_location(input4, file, 799, 16, 20094);
    			add_location(button, file, 800, 16, 20183);
    			attr_dev(div1, "class", "column svelte-1rwmkqc");
    			attr_dev(div1, "id", "speech-control");
    			add_location(div1, file, 798, 12, 20037);
    			attr_dev(div2, "class", "column svelte-1rwmkqc");
    			attr_dev(div2, "id", "view");
    			add_location(div2, file, 805, 12, 20400);
    			attr_dev(div3, "id", "gazercontrolbar");
    			attr_dev(div3, "class", "svelte-1rwmkqc");
    			add_location(div3, file, 786, 4, 19484);
    			attr_dev(div4, "id", "streamcontrolbar");
    			attr_dev(div4, "class", "svelte-1rwmkqc");
    			add_location(div4, file, 808, 4, 20453);
    			attr_dev(div5, "class", "column svelte-1rwmkqc");
    			attr_dev(div5, "id", "controller");
    			add_location(div5, file, 813, 8, 20552);
    			attr_dev(div6, "class", "column svelte-1rwmkqc");
    			attr_dev(div6, "id", "streaming");
    			add_location(div6, file, 816, 8, 20652);
    			attr_dev(div7, "id", "movementcontrolbar");
    			attr_dev(div7, "class", "svelte-1rwmkqc");
    			add_location(div7, file, 811, 4, 20513);
    			attr_dev(div8, "id", "topbar");
    			attr_dev(div8, "class", "svelte-1rwmkqc");
    			add_location(div8, file, 785, 0, 19462);
    			attr_dev(video, "class", "underlay svelte-1rwmkqc");
    			attr_dev(video, "id", "tamaview");
    			add_location(video, file, 867, 8, 21662);
    			attr_dev(div9, "class", "focus svelte-1rwmkqc");
    			set_style(div9, "-webkit-mask", "radial-gradient(circle at " + /*blurPoint*/ ctx[1][0] + "% " + /*blurPoint*/ ctx[1][1] + "%, #00000000 250px, rgba(0, 0, 0, 0.9) 0px)");
    			add_location(div9, file, 869, 8, 21847);
    			attr_dev(img, "class", "overlay svelte-1rwmkqc");
    			add_location(img, file, 870, 8, 22004);
    			attr_dev(div10, "class", "blur-container svelte-1rwmkqc");
    			add_location(div10, file, 866, 4, 21625);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(tama, div4, null);
    			append_dev(div8, t9);
    			append_dev(div8, div7);
    			append_dev(div7, div5);
    			mount_component(controller, div5, null);
    			append_dev(div7, t10);
    			append_dev(div7, div6);
    			mount_component(signaling, div6, null);
    			insert_dev(target, t11, anchor);
    			mount_component(gamepad, target, anchor);
    			insert_dev(target, t12, anchor);
    			insert_dev(target, div10, anchor);
    			append_dev(div10, video);
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(window_1, "keydown", /*onKeyDown*/ ctx[8], false, false, false, false),
    					listen_dev(window_1, "keyup", /*onKeyUp*/ ctx[9], false, false, false, false),
    					listen_dev(form, "submit", prevent_default(/*handleSubmit*/ ctx[10]), false, true, false, false),
    					listen_dev(button, "click", /*click_handler_1*/ ctx[17], false, false, false, false),
    					listen_dev(img, "mousedown", /*onMouseDown*/ ctx[11], false, false, false, false)
    				];
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*sendCol, collist*/ 4100) {
    				each_value = /*collist*/ ctx[12];
    				validate_each_argument(each_value);
    				let i;
    ...
    async function speakText(text) {
    	try {
    		...
    		const res = await fetch('./speak', { method: "POST", body: dataToSend });
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	async function sendSimpleWheel_pos() {
    		...
    		try {
    			const dataToSend = new FormData();
    			dataToSend.append("json", JSON.stringify({ movement }));
    	...
    	function LeftStick(event) {
    		$$invalidate(15, stateGamepad.leftAxis = event.detail, stateGamepad);
    	}

    	function RightStick(event) {
    		$$invalidate(15, stateGamepad.rightAxis = event.detail, stateGamepad);
    	}

    	function RSPressed(event) {
    		if ($$invalidate(15, stateGamepad.speedtoggle = 1, stateGamepad)) {
    			$$invalidate(15, stateGamepad.speedtoggle = 0.5, stateGamepad);
    		} else {
    			$$invalidate(15, stateGamepad.speedtoggle = 1, stateGamepad);
    		}
    	}
    	...
    	function RBPressed(event) {
    		if (stateGamepad.button["right"] != event.detail) {
    			if (stateGamepad.button["right"] == null) {
    				$$invalidate(15, stateGamepad.right = 400, stateGamepad);
    			}

    			stateGamepad.button["right"] == event.detail;
    		} else {
    			$$invalidate(15, stateGamepad.right = 0, stateGamepad);
    		}
    	}
    	...
    	function LBPressed(event) {
    		if (stateGamepad.button["left"] != event.detail) {
    			if (stateGamepad.button["left"] == null) {
    				$$invalidate(15, stateGamepad.left = -400, stateGamepad);
    			}

    			stateGamepad.button["left"] == event.detail;
    		} else {
    			$$invalidate(15, stateGamepad.left = 0, stateGamepad);
    		}
    	}
    	...
    	function updateKeyMovement() {
    		...
    		$$invalidate(13, stateTama.speed = speed, stateTama);

    		$$invalidate(13, stateTama.direction = direction, stateTama);
    		$$invalidate(13, stateTama.rotation = rotation, stateTama);
    	}
    	...
    	function handleSubmit(e) {
    		...
    		$$invalidate(13, stateTama.speed = data.s, stateTama);

    		$$invalidate(13, stateTama.direction = data.d, stateTama);
    		$$invalidate(13, stateTama.rotation = data.r, stateTama);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('stateTama' in $$props) $$invalidate(13, stateTama = $$props.stateTama);
    		if ('lastUpdate' in $$props) $$invalidate(14, lastUpdate = $$props.lastUpdate);
    		if ('stateGamepad' in $$props) $$invalidate(15, stateGamepad = $$props.stateGamepad);
    		if ('speed' in $$props) $$invalidate(35, speed = $$props.speed);
    		if ('stateKeyboard' in $$props) stateKeyboard = $$props.stateKeyboard;
    		if ('kmf' in $$props) kmf = $$props.kmf;
    		if ('kmb' in $$props) kmb = $$props.kmb;
    		if ('kml' in $$props) kml = $$props.kml;
    		if ('kmr' in $$props) kmr = $$props.kmr;
    		if ('krl' in $$props) krl = $$props.krl;
    		if ('krr' in $$props) krr = $$props.krr;
    		if ('speedToggle' in $$props) speedToggle = $$props.speedToggle;
    		...
    		if ('collist' in $$props) $$invalidate(12, collist = $$props.collist);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty[0] & /*stateGamepad, stateTama*/ 40960) {
    			{
    				...
    				if (newSpeed == 0) {
    					if (stateTama.speed != 0) {
    						$$invalidate(13, stateTama.speed = 0, stateTama);
    					}

    					$$invalidate(13, stateTama.rotation = stateGamepad.right + stateGamepad.left, stateTama);
    				} else {
    					$$invalidate(13, stateTama.rotation = (stateGamepad.right + stateGamepad.left) * 0.75, stateTama);
    				}

    				if (Math.abs(stateTama.speed - newSpeed) > 0.1 * speed) {
    					$$invalidate(13, stateTama.speed = newSpeed, stateTama);
    				...
    				if (newDegrees != stateTama.direction) {
    					$$invalidate(13, stateTama.direction = newDegrees, stateTama);
    				} //sendWheel('m',Math.round(degrees/11.25))
    			}
    		}

    		if ($$self.$$.dirty[0] & /*stateTama, lastUpdate*/ 24576) {
    			{
    				let obj = {
    					s: stateTama.speed,
    					d: stateTama.direction,
    				...
    				if (JSON.stringify(lastUpdate) != JSON.stringify(obj)) {
    					sendOmniWheel(obj);
    					$$invalidate(14, lastUpdate = obj);
    				}
    			}
    		}

    		if ($$self.$$.dirty[0] & /*stateGamepad*/ 32768) {
    			{
